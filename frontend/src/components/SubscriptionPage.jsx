  ...
  const plans = [
    {
      ...
      color: 'gray',
      features: [
        { text: t('landing.pricingUnlimitedPersonal'), included: true },
        { text: `1 ${t('landing.pricingSharedBill')}`, included: true },
        { text: `1 ${t('landing.pricingRecurring')}`, included: true },
        { text: t('landing.pricingBudgetCurrent'), included: true },
        { text: t('landing.pricingFriendsLocked'), included: false },
